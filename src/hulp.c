...
esp_err_t hulp_configure_analog_pin(gpio_num_t pin, adc_atten_t attenuation, adc_bitwidth_t width)
{
    ...
    if(adc_unit_index == 0)
    {
        ...
        //-------------ADC1 Config---------------//
        ESP_ERROR_CHECK(adc_oneshot_config_channel(adc1_handle, (adc_channel_t)adc_channel, &config));
        adc_cali_handle_t adc1_cali_chan0_handle = NULL;
        adc_cali_handle_t adc1_cali_chan1_handle = NULL;
        bool do_calibration1_chan0 = example_adc_calibration_init(ADC_UNIT_1, (adc_channel_t)adc_channel, attenuation, &adc1_cali_chan0_handle);
    }
    else
    {
        ...
        bool do_calibration2 = example_adc_calibration_init(ADC_UNIT_2, (adc_channel_t)adc_channel, attenuation, &adc2_cali_handle);

        //-------------ADC2 Config---------------//
        ESP_ERROR_CHECK(adc_oneshot_config_channel(adc2_handle, (adc_channel_t)adc_channel, &config));
    }
    return ESP_OK;
}
